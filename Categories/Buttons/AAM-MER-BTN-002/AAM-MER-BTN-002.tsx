...
const MeridianPulseButton: Component = () => {
  return (
    <>
      <style>{`
        :root{
      ...
      <div className="meridian-wrapper">
        <button
          type="button"
          className="meridian-pulse-button"
          aria-label="Activate Credits"
        >
          <span className="meridian-pulse-button__corner"></span>

          <span className="meridian-pulse-button__particles">
            <i className="meridian-pulse-button__particle"></i>
            <i className="meridian-pulse-button__particle"></i>
            <i className="meridian-pulse-button__particle"></i>
            <i className="meridian-pulse-button__particle"></i>
            <i className="meridian-pulse-button__particle"></i>
          ...
          <span className="meridian-pulse-button__content">
            <svg
              className="meridian-pulse-button__icon"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
...
export default MeridianPulseButton;